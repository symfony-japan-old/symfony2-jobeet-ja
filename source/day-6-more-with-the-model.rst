...
|  Doctrine によって生成されたSQLを参照する大きな助けとなります。
...
| 上記のコードは動作していても、2日目の「ユーザーは戻ってきて再度アクティブにするか、求人の期間の検証を30日以上に広げることが出来、、、」
| という要件から考慮すると、完璧にはほど遠いです。
...
| $category_id パラメータを受信した場合、カテゴリによってフィルタリングしたエンティティを照会します。
